...
kernel void chromaSelect(global float *I, float global *R, global float *S, global float *O, global float *M)
{
...
local function execute()
  ...
  proc:executeKernel("chromaSelect", proc:size2Dmax("O", "M"))
end
