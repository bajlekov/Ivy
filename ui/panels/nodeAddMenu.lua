...
overlayAdjust:addElem("addNode", 8, "Sample WB", {ops, "sampleWB"})
overlayAdjust:addElem("addNode", 9, "Set White", {ops, "setWP"})
local overlayCurves = Overlay:new("Curves:")
overlayAdjust:addElem("menu", 10, "Curves", overlayCurves)
overlayCurves:addElem("addNode", 1, "Levels", {ops, "levels"})
overlayCurves:addElem("addNode", 2, "Parametric", {ops, "parametric"})
overlayCurves:addElem("addNode", 3, "Curve Y", {ops, "curveY"})
overlayCurves:addElem("addNode", 4, "Curve RGB", {ops, "curveRGB"})
local overlayCurvesAdvanced = Overlay:new("Advanced:")
overlayCurves:addElem("menu", 5, "Advanced", overlayCurvesAdvanced)
...
overlayAdjust:addElem("menu", 11, "Live Adjust", overlayLiveAdjust)
...
overlayEnhance:addElem("addNode", 11, "Wiener Filter", {ops, "wiener"})
...
overlayCustom:addElem("addNode", 5, "Paint Mask", {ops, "paintMaskSmart"})
overlayCustom:addElem("addNode", 6, "Script Y", {ops, "scriptY"})
