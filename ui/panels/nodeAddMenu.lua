...
overlayCustom:addElem("addNode", 7, "Script Y", {ops, "scriptY"})
overlayCustom:addElem("addNode", 8, "Script RGB", {ops, "scriptRGB"})
overlayCustom:addElem("addNode", 9, "Script LAB", {ops, "scriptLAB"})
