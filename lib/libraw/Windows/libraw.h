...
enum LibRaw_image_formats
{
  ...
  __attribute__((dllimport)) void default_memory_callback(void *data, const char *file, const char *where);

  typedef void (*data_callback)(void *data, const char *file, const int offset);

  __attribute__((dllimport)) void default_data_callback(void *data, const char *file, const int offset);
...
struct tiff_hdr
{
  ...
  __attribute__((dllimport)) const char *libraw_strerror(int errorcode);
  __attribute__((dllimport)) const char *libraw_strprogress(enum LibRaw_progress);

  __attribute__((dllimport)) libraw_data_t *libraw_init(unsigned int flags);
  __attribute__((dllimport)) int libraw_open_file(libraw_data_t *, const char *);
  __attribute__((dllimport)) int libraw_open_file_ex(libraw_data_t *, const char *, INT64 max_buff_sz);




  __attribute__((dllimport)) int libraw_open_buffer(libraw_data_t *, void *buffer, size_t size);
  __attribute__((dllimport)) int libraw_unpack(libraw_data_t *);
  __attribute__((dllimport)) int libraw_unpack_thumb(libraw_data_t *);
  __attribute__((dllimport)) void libraw_recycle_datastream(libraw_data_t *);
  __attribute__((dllimport)) void libraw_recycle(libraw_data_t *);
  __attribute__((dllimport)) void libraw_close(libraw_data_t *);
  __attribute__((dllimport)) void libraw_subtract_black(libraw_data_t *);
  __attribute__((dllimport)) int libraw_raw2image(libraw_data_t *);
  __attribute__((dllimport)) void libraw_free_image(libraw_data_t *);

  __attribute__((dllimport)) const char *libraw_version();
  __attribute__((dllimport)) int libraw_versionNumber();

  __attribute__((dllimport)) const char **libraw_cameraList();
  __attribute__((dllimport)) int libraw_cameraCount();


  __attribute__((dllimport)) void libraw_set_memerror_handler(libraw_data_t *, memory_callback cb, void *datap);
  __attribute__((dllimport)) void libraw_set_exifparser_handler(libraw_data_t *, exif_parser_callback cb, void *datap);
  __attribute__((dllimport)) void libraw_set_dataerror_handler(libraw_data_t *, data_callback func, void *datap);
  __attribute__((dllimport)) void libraw_set_progress_handler(libraw_data_t *, progress_callback cb, void *datap);
  __attribute__((dllimport)) const char *libraw_unpack_function_name(libraw_data_t *lr);
  __attribute__((dllimport)) int libraw_get_decoder_info(libraw_data_t *lr, libraw_decoder_info_t *d);
  __attribute__((dllimport)) int libraw_COLOR(libraw_data_t *, int row, int col);
  __attribute__((dllimport)) unsigned libraw_capabilities();


  __attribute__((dllimport)) int libraw_adjust_sizes_info_only(libraw_data_t *);
  __attribute__((dllimport)) int libraw_dcraw_ppm_tiff_writer(libraw_data_t *lr, const char *filename);
  __attribute__((dllimport)) int libraw_dcraw_thumb_writer(libraw_data_t *lr, const char *fname);
  __attribute__((dllimport)) int libraw_dcraw_process(libraw_data_t *lr);
  __attribute__((dllimport)) libraw_processed_image_t *libraw_dcraw_make_mem_image(libraw_data_t *lr, int *errc);
  __attribute__((dllimport)) libraw_processed_image_t *libraw_dcraw_make_mem_thumb(libraw_data_t *lr, int *errc);
  __attribute__((dllimport)) void libraw_dcraw_clear_mem(libraw_processed_image_t *);

  __attribute__((dllimport)) void libraw_set_demosaic(libraw_data_t *lr, int value);
  __attribute__((dllimport)) void libraw_set_output_color(libraw_data_t *lr, int value);
  __attribute__((dllimport)) void libraw_set_user_mul(libraw_data_t *lr, int index, float val);
  __attribute__((dllimport)) void libraw_set_output_bps(libraw_data_t *lr, int value);
  __attribute__((dllimport)) void libraw_set_gamma(libraw_data_t *lr, int index, float value);
  __attribute__((dllimport)) void libraw_set_no_auto_bright(libraw_data_t *lr, int value);
  __attribute__((dllimport)) void libraw_set_bright(libraw_data_t *lr, float value);
  __attribute__((dllimport)) void libraw_set_highlight(libraw_data_t *lr, int value);
  __attribute__((dllimport)) void libraw_set_fbdd_noiserd(libraw_data_t *lr, int value);
  __attribute__((dllimport)) int libraw_get_raw_height(libraw_data_t *lr);
  __attribute__((dllimport)) int libraw_get_raw_width(libraw_data_t *lr);
  __attribute__((dllimport)) int libraw_get_iheight(libraw_data_t *lr);
  __attribute__((dllimport)) int libraw_get_iwidth(libraw_data_t *lr);
  __attribute__((dllimport)) float libraw_get_cam_mul(libraw_data_t *lr, int index);
  __attribute__((dllimport)) float libraw_get_pre_mul(libraw_data_t *lr, int index);
  __attribute__((dllimport)) float libraw_get_rgb_cam(libraw_data_t *lr, int index1, int index2);
  __attribute__((dllimport)) int libraw_get_color_maximum(libraw_data_t *lr);

  __attribute__((dllimport)) libraw_iparams_t *libraw_get_iparams(libraw_data_t *lr);
  __attribute__((dllimport)) libraw_lensinfo_t *libraw_get_lensinfo(libraw_data_t *lr);
  __attribute__((dllimport)) libraw_imgother_t *libraw_get_imgother(libraw_data_t *lr);
